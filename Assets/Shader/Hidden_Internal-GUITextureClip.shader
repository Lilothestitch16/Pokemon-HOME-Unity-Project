  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_1.xyz = float3(max(u_xlat10_0.xyz, float3(0, 0, 0)));
