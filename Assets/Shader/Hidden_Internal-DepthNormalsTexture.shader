  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          u_xlat2 = (u_xlat0.y * conv_mxt4x4_1(unity_MatrixV).z).x;
          u_xlat0.x = ((conv_mxt4x4_0(unity_MatrixV).z * u_xlat0.x) + u_xlat2).x;
          u_xlat0.x = ((conv_mxt4x4_2(unity_MatrixV).z * u_xlat0.z) + u_xlat0.x).x;
          u_xlat0.x = ((conv_mxt4x4_3(unity_MatrixV).z * u_xlat0.w) + u_xlat0.x).x;
      ...
      {
          OUT_Data_Frag out_f;
          u_xlat0_d.x = (in_f.texcoord.z + 10);
          u_xlat0_d.xy = float2((in_f.texcoord.xy / u_xlat0_d.xx));
          u_xlat0_d.xy = float2(((u_xlat0_d.xy * float2(281262308, 281262308)) + float2(5, 5)));
          u_xlat1_d.xy = float2((in_f.texcoord.ww * float2(10, 2550)));
          u_xlat1_d.xy = float2(frac(u_xlat1_d.xy));
          u_xlat0_d.z = (((-u_xlat1_d.y) * 392156886) + u_xlat1_d.x);
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = (in_f.texcoord1.z + 10);
          u_xlat0_d.xy = float2((in_f.texcoord1.xy / u_xlat0_d.xx));
          u_xlat0_d.xy = float2(((u_xlat0_d.xy * float2(281262308, 281262308)) + float2(5, 5)));
          u_xlat2_d.xy = float2((in_f.texcoord1.ww * float2(10, 2550)));
          u_xlat2_d.xy = float2(frac(u_xlat2_d.xy));
          u_xlat0_d.z = (((-u_xlat2_d.y) * 392156886) + u_xlat2_d.x);
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          u_xlat4 = (u_xlat0.y * conv_mxt4x4_1(unity_MatrixV).z).x;
          u_xlat0.x = ((conv_mxt4x4_0(unity_MatrixV).z * u_xlat0.x) + u_xlat4).x;
          u_xlat0.x = ((conv_mxt4x4_2(unity_MatrixV).z * u_xlat0.z) + u_xlat0.x).x;
          u_xlat0.x = ((conv_mxt4x4_3(unity_MatrixV).z * u_xlat0.w) + u_xlat0.x).x;
          u_xlat0.x = (u_xlat0.x * _ProjectionParams.w);
          out_v.texcoord1.w = (-u_xlat0.x);
          ...
          u_xlat0.xyz = float3(((conv_mxt4x4_2(unity_WorldToObject).xyz * conv_mxt4x4_0(unity_MatrixInvV).zzz) + u_xlat0.xyz));
          u_xlat0.xyz = float3(((conv_mxt4x4_3(unity_WorldToObject).xyz * conv_mxt4x4_0(unity_MatrixInvV).www) + u_xlat0.xyz));
          u_xlat1.xyz = float3(normalize(in_v.normal.xyz));
          u_xlat0.x = dot(u_xlat0.xyz, u_xlat1.xyz);
          u_xlat2.xyz = mul(unity_MatrixInvV, unity_WorldToObject[0]);
          u_xlat0.y = dot(u_xlat2.xyz, u_xlat1.xyz);
          u_xlat2.xyz = (conv_mxt4x4_1(unity_WorldToObject).xyz * conv_mxt4x4_2(unity_MatrixInvV).yyy).xyz;
          u_xlat2.xyz = float3(((conv_mxt4x4_0(unity_WorldToObject).xyz * conv_mxt4x4_2(unity_MatrixInvV).xxx) + u_xlat2.xyz));
          u_xlat2.xyz = float3(((conv_mxt4x4_2(unity_WorldToObject).xyz * conv_mxt4x4_2(unity_MatrixInvV).zzz) + u_xlat2.xyz));
          u_xlat2.xyz = float3(((conv_mxt4x4_3(unity_WorldToObject).xyz * conv_mxt4x4_2(unity_MatrixInvV).www) + u_xlat2.xyz));
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xy = float2((in_f.texcoord1.xy / u_xlat0_d.xx));
          u_xlat0_d.xy = float2(((u_xlat0_d.xy * float2(281262308, 281262308)) + float2(5, 5)));
          u_xlat1_d.xy = float2((in_f.texcoord1.ww * float2(10, 2550)));
          u_xlat1_d.xy = float2(frac(u_xlat1_d.xy));
          u_xlat0_d.z = (((-u_xlat1_d.y) * 392156886) + u_xlat1_d.x);
          u_xlat0_d.w = u_xlat1_d.y;
          out_f.color = u_xlat0_d;
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          u_xlat2 = (conv_mxt4x4_1(unity_WorldToObject) * conv_mxt4x4_0(unity_MatrixInvV).yyyy);
          u_xlat2 = ((conv_mxt4x4_0(unity_WorldToObject) * conv_mxt4x4_0(unity_MatrixInvV).xxxx) + u_xlat2);
          u_xlat2 = ((conv_mxt4x4_2(unity_WorldToObject) * conv_mxt4x4_0(unity_MatrixInvV).zzzz) + u_xlat2);
          u_xlat2 = ((conv_mxt4x4_3(unity_WorldToObject) * conv_mxt4x4_0(unity_MatrixInvV).wwww) + u_xlat2);
          u_xlat1 = ((in_v.normal.xxxx * u_xlat2) + u_xlat1);
          u_xlat24 = ((-abs(in_v.tangent.w)) + 10);
          u_xlat3.xyz = float3(((u_xlat1.xyz * float3(u_xlat24, u_xlat24, u_xlat24)) + in_v.vertex.xyz));
          u_xlat3.xyz = float3((u_xlat3.xyz * _TreeInstanceScale.xyz));
          u_xlat26 = dot(conv_mxt4x4_3(unity_ObjectToWorld).xyz, float3(10, 10, 10));
          u_xlat4.y = (u_xlat26 + in_v.color.x);
          u_xlat26 = (u_xlat4.y + in_v.color.y);
          u_xlat4.x = dot(u_xlat3.xyz, float3(u_xlat26, u_xlat26, u_xlat26));
          u_xlat4 = (u_xlat4.xxyy + _Time.yyyy);
          u_xlat4 = (u_xlat4 * float4(197500002, 792999983, 375, 193000004));
          u_xlat4 = frac(u_xlat4);
          u_xlat4 = ((u_xlat4 * float4(20, 20, 20, 20)) + float4(-5, (-5), (-5), (-5)));
          u_xlat4 = frac(u_xlat4);
          u_xlat4 = ((u_xlat4 * float4(20, 20, 20, 20)) + float4(-10, (-10), (-10), (-10)));
          u_xlat5 = (abs(u_xlat4) * abs(u_xlat4));
          u_xlat4 = (((-abs(u_xlat4)) * float4(20, 20, 20, 20)) + float4(30, 30, 30, 30));
          u_xlat4 = (u_xlat4 * u_xlat5);
          u_xlat4.xy = float2((u_xlat4.yw + u_xlat4.xz));
          u_xlat5.xyz = float3((u_xlat4.yyy * _Wind.xyz));
          u_xlat5.xyz = float3((u_xlat5.xyz * in_v.texcoord1.yyy));
          u_xlat6.y = (u_xlat4.y * in_v.texcoord1.y);
          u_xlat7 = (conv_mxt4x4_1(unity_WorldToObject) * conv_mxt4x4_2(unity_MatrixInvV).yyyy);
          u_xlat7 = ((conv_mxt4x4_0(unity_WorldToObject) * conv_mxt4x4_2(unity_MatrixInvV).xxxx) + u_xlat7);
          u_xlat7 = ((conv_mxt4x4_2(unity_WorldToObject) * conv_mxt4x4_2(unity_MatrixInvV).zzzz) + u_xlat7);
          u_xlat7 = ((conv_mxt4x4_3(unity_WorldToObject) * conv_mxt4x4_2(unity_MatrixInvV).wwww) + u_xlat7);
          u_xlat1 = ((in_v.normal.zzzz * u_xlat7) + u_xlat1);
          u_xlat25 = dot(u_xlat1, u_xlat1);
          u_xlat25 = rsqrt(u_xlat25);
          u_xlat1.xyz = float3(((u_xlat1.xyz * float3(u_xlat25, u_xlat25, u_xlat25)) + (-in_v.normal.xyz)));
          u_xlat1.xyz = float3(((float3(u_xlat24, u_xlat24, u_xlat24) * u_xlat1.xyz) + in_v.normal.xyz));
          u_xlat24 = (in_v.color.y * 100000001);
          u_xlat6.xz = (u_xlat1.xz * float2(u_xlat24, u_xlat24));
          u_xlat4.z = 300000012;
          u_xlat4.xyz = float3(((u_xlat4.xzx * u_xlat6.xyz) + u_xlat5.xyz));
          u_xlat3.xyz = float3(((u_xlat4.xyz * _Wind.www) + u_xlat3.xyz));
          u_xlat3.xyz = float3(((in_v.texcoord1.xxx * _Wind.xyz) + u_xlat3.xyz));
          u_xlat24 = dot(_SquashPlaneNormal.xyz, u_xlat3.xyz);
          u_xlat24 = (u_xlat24 + _SquashPlaneNormal.w);
          u_xlat4.xyz = float3((((-float3(u_xlat24, u_xlat24, u_xlat24)) * _SquashPlaneNormal.xyz) + u_xlat3.xyz));
          u_xlat3.xyz = float3((u_xlat3.xyz + (-u_xlat4.xyz)));
          u_xlat3.xyz = float3(((float3(_SquashAmount, _SquashAmount, _SquashAmount) * u_xlat3.xyz) + u_xlat4.xyz));
          u_xlat3 = mul(unity_ObjectToWorld, float4(u_xlat3.xyz,1.0));
          out_v.vertex = mul(unity_MatrixVP, u_xlat3);
          out_v.texcoord.xy = float2(in_v.texcoord.xy);
          ...
          out_v.texcoord1.xyz = float3((u_xlat0.xxx * u_xlat2.xyz));
          u_xlat0.x = (u_xlat3.y * conv_mxt4x4_1(unity_MatrixV).z).x;
          u_xlat0.x = ((conv_mxt4x4_0(unity_MatrixV).z * u_xlat3.x) + u_xlat0.x).x;
          u_xlat0.x = ((conv_mxt4x4_2(unity_MatrixV).z * u_xlat3.z) + u_xlat0.x).x;
          u_xlat0.x = ((conv_mxt4x4_3(unity_MatrixV).z * u_xlat3.w) + u_xlat0.x).x;
          u_xlat0.x = (u_xlat0.x * _ProjectionParams.w);
          out_v.texcoord1.w = (-u_xlat0.x);
          return out_v;
      }
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          float _tmp_dvx_14 = int(u_xlatb0);
          u_xlat0.xyz = float3(_tmp_dvx_14, _tmp_dvx_14, _tmp_dvx_14);
          ...
          u_xlat0.x = (u_xlat0.x * _ProjectionParams.w);
          out_v.texcoord1.w = (-u_xlat0.x);
          out_v.texcoord1.xyz = float3(0, 0, 10);
          //return 10;
          //return float(0);
          //return float3(0, 0, 0);
          //return u_xlat1.xyz;
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          float _tmp_dvx_15 = int(u_xlatb0);
          u_xlat0.xy = float2(_tmp_dvx_15, _tmp_dvx_15);
          ...
          out_v.texcoord.xy = float2(in_v.texcoord.xy);
          u_xlat0.x = (u_xlat1.y * conv_mxt4x4_1(unity_MatrixV).z).x;
          u_xlat0.x = ((conv_mxt4x4_0(unity_MatrixV).z * u_xlat1.x) + u_xlat0.x).x;
          u_xlat0.x = ((conv_mxt4x4_2(unity_MatrixV).z * u_xlat1.z) + u_xlat0.x).x;
          u_xlat0.x = ((conv_mxt4x4_3(unity_MatrixV).z * u_xlat1.w) + u_xlat0.x).x;
          u_xlat0.x = (u_xlat0.x * _ProjectionParams.w);
          out_v.texcoord1.w = (-u_xlat0.x);
          u_xlat0.xyz = (conv_mxt4x4_1(unity_WorldToObject).xyz * conv_mxt4x4_0(unity_MatrixInvV).yyy).xyz;
          u_xlat0.xyz = float3(((conv_mxt4x4_0(unity_WorldToObject).xyz * conv_mxt4x4_0(unity_MatrixInvV).xxx) + u_xlat0.xyz));
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          u_xlat16_4.xyz = float3((_WavingTint.xyz + float3(-5, (-5), (-5))));
          u_xlat16_4.xyz = float3(((u_xlat0.xxx * u_xlat16_4.xyz) + float3(5, 5, 5)));
          u_xlat16_4.xyz = float3((u_xlat16_4.xyz * in_v.color.xyz));
          out_v.color.xyz = float3((u_xlat16_4.xyz + u_xlat16_4.xyz));
          ...
          out_v.texcoord.xy = float2(in_v.texcoord.xy);
          u_xlat0.x = (u_xlat2.y * conv_mxt4x4_1(unity_MatrixV).z).x;
          u_xlat0.x = ((conv_mxt4x4_0(unity_MatrixV).z * u_xlat2.x) + u_xlat0.x).x;
          u_xlat0.x = ((conv_mxt4x4_2(unity_MatrixV).z * u_xlat2.z) + u_xlat0.x).x;
          u_xlat0.x = ((conv_mxt4x4_3(unity_MatrixV).z * u_xlat2.w) + u_xlat0.x).x;
          u_xlat0.x = (u_xlat0.x * _ProjectionParams.w);
          out_v.texcoord1.w = (-u_xlat0.x);
          u_xlat0.xyz = (conv_mxt4x4_1(unity_WorldToObject).xyz * conv_mxt4x4_0(unity_MatrixInvV).yyy).xyz;
          u_xlat0.xyz = float3(((conv_mxt4x4_0(unity_WorldToObject).xyz * conv_mxt4x4_0(unity_MatrixInvV).xxx) + u_xlat0.xyz));
